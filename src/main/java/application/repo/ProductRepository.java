...
public interface ProductRepository extends CrudRepository<Product, Long> {
    ...
    @Modifying
    @Transactional
    @Query(value="INSERT INTO products (name, categoryId, tag, description, image, price, amount) values(?,?,?,?,?,?,?)", nativeQuery = true)
    void addProduct(@Param("name") String name, @Param("categoryId") Integer categoryId, @Param("tag") String tag,
