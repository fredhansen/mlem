...
public class ProductCheck {
    ...
    @Test
    public void Add_Product_And_Category_Then_Check_In_Warehouse() throws IOException, JSONException {
    ...
    private JSONObject get_Category_Response_In_JsonObject() throws JSONException {
        WebDriverWait wait = new WebDriverWait(driver,25);
        wait.until(ExpectedConditions.elementToBeClickable(driver.findElementById("getCategoryStatus")));
    ...
    private JSONObject get_Product_Response_In_JsonObject() throws JSONException {
        WebDriverWait wait = new WebDriverWait(driver,25);
        wait.until(ExpectedConditions.elementToBeClickable(driver.findElementById("getAddingStatus")));
    ...
    private void search_Category_In_Warehouse(Category category){
        ...
        driver.findElementById("searchInput").sendKeys(category.getName());
